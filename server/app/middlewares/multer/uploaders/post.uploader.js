/**
 * @file server/app/middlewares/multer/uploaders/post.uploader.js
  ...
  const upload = multer({
    ...
    storage: multer.diskStorage({
      ...
      destination: (req, file, cb) => {
        ...
        cb(null, process.env.FILE_POST_IMAGE_PATH); // multer 기본 내부 탑재 콜백함수, 에러가 날시 첫 인자에 null -> error로 들어온다
      },
      // 파일명 설정
